...
<html lang="en">
	<head>
		...
		<link rel="icon" href="http://qotone.000webhostapp.com/hms/sanjivani/images/favicon.ico" type="image/x-icon">
		<meta charset="utf-8" />
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2><img src="../images/logo.png" style="width:195px; height:65px;"> | Patient Login</h2></a>
				</div>
